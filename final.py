...
df.dataframeName = 'midyear_population_age_country_code.csv'
nRow, nCol = df.shape
...
fig = go.Figure(data=go.Choropleth(
    ...
    z = (sbdgroup16['youths']/(sbdgroup16['kids']+sbdgroup16['youths']+sbdgroup16['middle_aged']+sbdgroup16['old_aged']))*100,
...
fig.update_layout(
    title_text='Percentage of Youths in 2016',
    geo=dict(
        showframe=False,
