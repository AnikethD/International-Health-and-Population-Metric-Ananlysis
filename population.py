...
t2 = spark.read.option('header','true').csv("hdfs://localhost:9000/project/midyear_population_age_country_code.csv")
with hd.open("/project/midyear_population_age_country_code.csv") as b:
    df1 =  pd.read_csv(b)

df1.dataframeName = 'midyear_population_age_country_code.csv'
nRow, nCol = df1.shape
...
sbd = df1[['code','population_age_50','year']]
...
fig = go.Figure(data=go.Choropleth(
    ...
    z = sbdgroup36['population_age_50'],
